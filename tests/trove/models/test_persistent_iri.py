...
class TestPersistentIri(TestCase):
    ...
    def test_scheme_equivalence_with_authority(self):
        ...
        self.assertEqual(self.piri_foo.as_str(), 'foo://wibbleplop.example/la')
        ...
        self.assertEqual(_piri_foo.as_str(), 'foo://wibbleplop.example/la')
        ...
        self.assertEqual(_piri_bar.as_str(), 'foo://wibbleplop.example/la')
        ...
        self.assertEqual(_piri_http.as_str(), 'http://wibbleplop.example/la')
        ...
        self.assertEqual(_piri_https.as_str(), 'https://wibbleplop.example/la')
    ...
    def test_equivalence_without_authority(self):
        ...
        self.assertEqual(_piri.as_str(), 'ha:ba:pow')
