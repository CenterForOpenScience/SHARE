...
class TestDeleteCascadeShareObjects:
    ...
    def test_one_version(self):
        ...
        assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 1

        cw.delete()

        assert models.CreativeWork.objects.all().count() == 0
        assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 0
    ...
    def test_many_versions(self):
        ...
        assert models.CreativeWork.objects.all().count() == 1
        assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 2
    ...
    def test_no_truncate(self):
        ...
        assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 10

        for i, cw in enumerate(cws):
            cw.delete()
            assert models.CreativeWork.objects.all().count() == 9 - i
            assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 9 - i
...
class TestDeleteCascadeRelations:
    ...
    def test_foreign_key(self):
        ...
        assert models.AbstractCreativeWork.objects.exclude(id=None).count() == 1
        assert models.WorkIdentifierVersion.objects.exclude(id=None).count() == 1
        assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 1
        ...
        assert models.AbstractCreativeWork.objects.exclude(id=None).count() == 1
        assert models.WorkIdentifierVersion.objects.exclude(id=None).count() == 0
        assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 1
    ...
    def test_foreign_key_inverse(self):
        ...
        assert models.WorkIdentifier.objects.exclude(id=None).count() == 0
        assert models.AbstractCreativeWork.objects.exclude(id=None).count() == 0
        assert models.WorkIdentifierVersion.objects.exclude(id=None).count() == 0
        assert models.AbstractCreativeWorkVersion.objects.exclude(id=None).count() == 0
    ...
    def test_many_to_many(self):
        ...
        for model, (count, version_count) in {
            ...
            assert model.VersionModel.objects.exclude(id=None).count() == version_count
...
class TestDeleteCascadeNonShareObjects:
    ...
    def test_changeset(self):
        ...
        assert models.Change.objects.exclude(id=None).count() == 0
        assert models.AbstractCreativeWork.objects.exclude(id=None).count() == 0
    ...
    def test_normalizeddata(self):
        ...
        assert models.Change.objects.exclude(id=None).count() == 0
        assert models.ChangeSet.objects.exclude(id=None).count() == 0
        assert models.AbstractCreativeWork.objects.exclude(id=None).count() == 0
    ...
    def test_rawdata(self):
        ...
        assert models.Change.objects.exclude(id=None).count() == 0
        assert models.ChangeSet.objects.exclude(id=None).count() == 0
        assert models.NormalizedData.objects.exclude(id=None).count() == 0
        assert models.AbstractCreativeWork.objects.exclude(id=None).count() == 0
...
class TestDeleteCascade:
    ...
    def test_delete_cascade(self, queryset, deltas, Graph):
        ...
        before = {model: model.objects.exclude(id=None).count() for model in deltas.keys()}

        queryset.delete()

        for model, delta in deltas.items():
            assert model.objects.exclude(id=None).count() - before[model] == delta
