...
class TestVersioning:
    ...
    def test_timestamping(share_source):
        p = Person(given_name='John', family_name='Doe')
        p.save()
    ...
    @pytest.mark.django_db
    def test_creates_version(share_source):
        p = Person(given_name='John', family_name='Doe')
        p.save()
        p.refresh_from_db()
    ...
    @pytest.mark.django_db
    def test_relations(self, john_doe):
        ident = Identifier.objects.create(base_url='http://dinosaurs.sexy/', url='http://dinosaurs.sexy/john_doe')
    ...
    @pytest.mark.django_db
    def test_relations_related_changed(self, john_doe):
        ident = Identifier.objects.create(base_url='http://dinosaurs.sexy/', url='http://dinosaurs.sexy/john_doe')
