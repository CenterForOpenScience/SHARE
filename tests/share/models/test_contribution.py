...
class TestAbstractContribution:
    ...
    def test_exists(self):
        ...
        for contribution in x.contribution_set.all():
...
class TestThroughContribution:
    ...
    def test_exists(self):
        ...
        collaboration = factories.ContributionFactory(creative_work=pp, entity=person, type='share.collaboratorcontribution')
        factories.ThroughContributionFactory(origin=collaboration, destination=consortium_collaboration, change=factories.ChangeFactory())
    ...
    def test_must_share_creative_work(self):
        ...
        with pytest.raises(ValidationError) as e:
            factories.ThroughContributionFactory(origin=collaboration, destination=consortium_collaboration)
    ...
    def test_cannot_be_self(self):
        ...
        with pytest.raises(ValidationError) as e:
            factories.ThroughContributionFactory(origin=collaboration, destination=collaboration)
