# Generated by Django 3.2.5 on 2023-07-05 21:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='derivedindexcard',
            name='suid',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='derived_indexcard_set', to='share.sourceuniqueidentifier'),
        ),
        migrations.AddField(
            model_name='derivedindexcard',
            name='upriver_card',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='derived_indexcard_set', to='trove.rdfindexcard'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='derivedindexcard',
            constraint=models.UniqueConstraint(fields=('suid', 'deriver_piri'), name='trove_derivedindexcard_suid_deriverpiri'),
        ),
    ]
