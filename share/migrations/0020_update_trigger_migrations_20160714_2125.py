# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-14 21:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql='CREATE OR REPLACE FUNCTION before_share_throughawardfunders_change() RETURNS trigger AS $$\n        DECLARE\n            vid INTEGER;\n        BEGIN\n            INSERT INTO share_throughawardfundersversion(persistent_id, action, award_id, award_version_id, change_id, date_created, date_modified, extra_id, extra_version_id, funder_id, funder_version_id, same_as_id, same_as_version_id, uuid) VALUES (NEW.id, TG_OP, NEW.award_id, NEW.award_version_id, NEW.change_id, NEW.date_created, NEW.date_modified, NEW.extra_id, NEW.extra_version_id, NEW.funder_id, NEW.funder_version_id, NEW.same_as_id, NEW.same_as_version_id, NEW.uuid) RETURNING (id) INTO vid;\n            NEW.version_id = vid;\n            RETURN NEW;\n        END;\n        $$ LANGUAGE plpgsql;',
            reverse_sql='DROP FUNCTION before_share_throughawardfunders_change();',
        ),
        migrations.RunSQL(
            sql='DROP TRIGGER IF EXISTS share_throughawardfunders_change ON share_throughawardfunders;\n\n        CREATE TRIGGER share_throughawardfunders_change\n        BEFORE INSERT OR UPDATE ON share_throughawardfunders\n        FOR EACH ROW\n        EXECUTE PROCEDURE before_share_throughawardfunders_change();',
            reverse_sql='DROP TRIGGER share_throughawardfunders_change',
        ),
        migrations.RunSQL(
