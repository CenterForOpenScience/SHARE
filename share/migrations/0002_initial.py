# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-11-17 01:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AbstractAgent',
            fields=[
                ('type', models.CharField(choices=[('share.agent', 'agent'), ('share.organization', 'organization'), ('share.consortium', 'consortium'), ('share.institution', 'institution'), ('share.person', 'person')], db_index=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('share.agentversion', 'agent version'), ('share.organizationversion', 'organization version'), ('share.consortiumversion', 'consortium version'), ('share.institutionversion', 'institution version'), ('share.personversion', 'person version')], db_index=True, max_length=255)),
                ('action', models.TextField(max_length=10)),
                ('persistent_id', models.PositiveIntegerField()),
                ('name', models.TextField(blank=True)),
                ('location', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('share.agentworkrelation', 'agent work relation'), ('share.host', 'host'), ('share.contributor', 'contributor'), ('share.principalinvestigator', 'principal investigator'), ('share.creator', 'creator'), ('share.publisher', 'publisher'), ('share.funder', 'funder')], db_index=True, max_length=255)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('share.agentworkrelationversion', 'agent work relation version'), ('share.hostversion', 'host version'), ('share.contributorversion', 'contributor version'), ('share.principalinvestigatorversion', 'principal investigator version'), ('share.creatorversion', 'creator version'), ('share.publisherversion', 'publisher version'), ('share.funderversion', 'funder version')], db_index=True, max_length=255)),
                ('action', models.TextField(max_length=10)),
                ('persistent_id', models.PositiveIntegerField()),
                ('cited_as', models.TextField(blank=True)),
                ('date_created', models.DateTimeField(auto_now_add=True, help_text='The date of ingress to SHARE.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creative_work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subject_relations', to='share.AbstractCreativeWork')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.Subject')),
            ],
            options={
                'db_table': None,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creative_work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tag_relations', to='share.AbstractCreativeWork')),
                ('creative_work_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractCreativeWorkVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
