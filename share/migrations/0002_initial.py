...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AbstractAgent',
            fields=[
                ('type', models.CharField(choices=[('share.agent', 'agent'), ('share.institution', 'institution'), ('share.person', 'person'), ('share.consortium', 'consortium'), ('share.organization', 'organization')], db_index=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('share.agentversion', 'agent version'), ('share.institutionversion', 'institution version'), ('share.personversion', 'person version'), ('share.consortiumversion', 'consortium version'), ('share.organizationversion', 'organization version')], db_index=True, max_length=255)),
                ('action', models.TextField(max_length=10)),
                ('persistent_id', models.PositiveIntegerField()),
                ('name', models.TextField(blank=True)),
                ('location', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('share.agentworkrelation', 'agent work relation'), ('share.publisher', 'publisher'), ('share.contributor', 'contributor'), ('share.principalinvestigator', 'principal investigator'), ('share.creator', 'creator'), ('share.funder', 'funder'), ('share.host', 'host')], db_index=True, max_length=255)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('share.agentworkrelationversion', 'agent work relation version'), ('share.publisherversion', 'publisher version'), ('share.contributorversion', 'contributor version'), ('share.principalinvestigatorversion', 'principal investigator version'), ('share.creatorversion', 'creator version'), ('share.funderversion', 'funder version'), ('share.hostversion', 'host version')], db_index=True, max_length=255)),
                ('action', models.TextField(max_length=10)),
                ('persistent_id', models.PositiveIntegerField()),
                ('cited_as', models.TextField(blank=True)),
                ('date_modified', models.DateTimeField(auto_now=True, db_index=True, help_text='The date this record was modified by SHARE.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('share.creativework', 'creative work'), ('share.presentation', 'presentation'), ('share.dataset', 'data set'), ('share.publication', 'publication'), ('share.article', 'article'), ('share.registration', 'registration'), ('share.dissertation', 'dissertation'), ('share.book', 'book'), ('share.conferencepaper', 'conference paper'), ('share.thesis', 'thesis'), ('share.project', 'project'), ('share.preprint', 'preprint'), ('share.report', 'report'), ('share.workingpaper', 'working paper'), ('share.software', 'software'), ('share.poster', 'poster')], db_index=True, max_length=255)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('share.creativeworkversion', 'creative work version'), ('share.presentationversion', 'presentation version'), ('share.datasetversion', 'data set version'), ('share.publicationversion', 'publication version'), ('share.articleversion', 'article version'), ('share.registrationversion', 'registration version'), ('share.dissertationversion', 'dissertation version'), ('share.bookversion', 'book version'), ('share.conferencepaperversion', 'conference paper version'), ('share.thesisversion', 'thesis version'), ('share.projectversion', 'project version'), ('share.preprintversion', 'preprint version'), ('share.reportversion', 'report version'), ('share.workingpaperversion', 'working paper version'), ('share.softwareversion', 'software version'), ('share.posterversion', 'poster version')], db_index=True, max_length=255)),
                ('action', models.TextField(max_length=10)),
                ('persistent_id', models.PositiveIntegerField()),
                ('title', models.TextField(blank=True)),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('share.workrelation', 'work relation'), ('share.documents', 'documents'), ('share.ispartof', 'is part of'), ('share.isidenticalto', 'is identical to'), ('share.reviews', 'reviews'), ('share.compiles', 'compiles'), ('share.extends', 'extends'), ('share.cites', 'cites'), ('share.isderivedfrom', 'is derived from'), ('share.issupplementto', 'is supplement to'), ('share.references', 'references')], db_index=True, max_length=255)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('date_modified', models.DateTimeField(auto_now=True, db_index=True, help_text='The date this record was modified by SHARE.')),
                ('date_created', models.DateTimeField(auto_now_add=True, help_text='The date of ingress to SHARE.')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('share.workrelationversion', 'work relation version'), ('share.documentsversion', 'documents version'), ('share.ispartofversion', 'is part of version'), ('share.isidenticaltoversion', 'is identical to version'), ('share.reviewsversion', 'reviews version'), ('share.compilesversion', 'compiles version'), ('share.extendsversion', 'extends version'), ('share.citesversion', 'cites version'), ('share.isderivedfromversion', 'is derived from version'), ('share.issupplementtoversion', 'is supplement to version'), ('share.referencesversion', 'references version')], db_index=True, max_length=255)),
                ('action', models.TextField(max_length=10)),
                ('persistent_id', models.PositiveIntegerField()),
                ('date_modified', models.DateTimeField(auto_now=True, db_index=True, help_text='The date this record was modified by SHARE.')),
                ('date_created', models.DateTimeField(auto_now_add=True, help_text='The date of ingress to SHARE.')),
