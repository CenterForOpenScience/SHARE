    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractContribution')),
                ('destination_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractContributionVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractContribution')),
                ('origin_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractContributionVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contribution_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.AbstractContributionVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sources', models.ManyToManyField(editable=False, related_name='source_throughcontributionversion', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
                'ordering': ('-date_modified',),
        ...
        migrations.AddField(
            model_name='abstractworkrelationversion',
            name='from_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractworkrelationversions', to='share.AbstractCreativeWork'),
        ),
        migrations.AddField(
            model_name='abstractworkrelationversion',
            name='from_work_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractworkrelationversions', to='share.AbstractCreativeWorkVersion'),
        ),
        migrations.AddField(
            model_name='abstractworkrelationversion',
            name='same_as',
        ...
        migrations.AddField(
            model_name='abstractworkrelationversion',
            name='sources',
            field=models.ManyToManyField(editable=False, related_name='source_abstractworkrelationversion', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='abstractworkrelationversion',
            name='to_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractworkrelationversions', to='share.AbstractCreativeWork'),
        ),
        migrations.AddField(
            model_name='abstractworkrelationversion',
            name='to_work_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractworkrelationversions', to='share.AbstractCreativeWorkVersion'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='abstractworkrelation',
            name='from_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractworkrelations', to='share.AbstractCreativeWork'),
        ),
        migrations.AddField(
            model_name='abstractworkrelation',
            name='from_work_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractworkrelations', to='share.AbstractCreativeWorkVersion'),
        ),
        migrations.AddField(
            model_name='abstractworkrelation',
            name='same_as',
        ...
        migrations.AddField(
            model_name='abstractworkrelation',
            name='to_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractworkrelations', to='share.AbstractCreativeWork'),
        ),
        migrations.AddField(
            model_name='abstractworkrelation',
            name='to_work_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractworkrelations', to='share.AbstractCreativeWorkVersion'),
        ),
        migrations.AddField(
            model_name='abstractworkrelation',
            name='version',
        ...
        migrations.AddField(
            ...
            field=share.models.fields.TypedManyToManyField(editable=False, through='share.AbstractEntityRelation', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityversion',
        ...
        migrations.AddField(
            model_name='abstractentityrelationversion',
            name='from_entity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractentityrelationversions', to='share.AbstractEntity'),
        ),
        migrations.AddField(
            model_name='abstractentityrelationversion',
            name='from_entity_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractentityrelationversions', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityrelationversion',
            name='same_as',
        ...
        migrations.AddField(
            model_name='abstractentityrelationversion',
            name='sources',
            field=models.ManyToManyField(editable=False, related_name='source_abstractentityrelationversion', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='abstractentityrelationversion',
            name='to_entity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractentityrelationversions', to='share.AbstractEntity'),
        ),
        migrations.AddField(
            model_name='abstractentityrelationversion',
            name='to_entity_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractentityrelationversions', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='abstractentityrelation',
            name='from_entity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractentityrelations', to='share.AbstractEntity'),
        ),
        migrations.AddField(
            model_name='abstractentityrelation',
            name='from_entity_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_abstractentityrelations', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityrelation',
            name='same_as',
        ...
        migrations.AddField(
            model_name='abstractentityrelation',
            name='to_entity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractentityrelations', to='share.AbstractEntity'),
        ),
        migrations.AddField(
            model_name='abstractentityrelation',
            name='to_entity_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='incoming_abstractentityrelations', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityrelation',
            name='version',
        ...
        migrations.AddField(
            ...
            field=share.models.fields.TypedManyToManyField(editable=False, through='share.AbstractContribution', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
            model_name='abstractcreativeworkversion',
            name='contributors',
        ...
        migrations.AddField(
            ...
            field=share.models.fields.TypedManyToManyField(editable=False, through='share.AbstractWorkRelation', to='share.AbstractCreativeWorkVersion'),
        ),
        migrations.AddField(
            model_name='abstractcreativeworkversion',
            name='related_works',
        ...
        migrations.AddField(
            ...
            field=share.models.fields.TypedManyToManyField(editable=False, through='share.ThroughContribution', to='share.AbstractContributionVersion'),
        ),
        migrations.AddField(
            model_name='abstractcontributionversion',
        ...
        migrations.AddField(
            model_name='abstractcontributionversion',
            name='sources',
            field=models.ManyToManyField(editable=False, related_name='source_abstractcontributionversion', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='abstractworkrelation',
            unique_together=set([('from_work', 'to_work', 'type')]),
        ),
        migrations.AlterIndexTogether(
            name='abstractentityversion',
        ...
        migrations.AlterUniqueTogether(
            name='abstractentityrelation',
            unique_together=set([('from_entity', 'to_entity', 'type')]),
        ),
        migrations.AlterIndexTogether(
            name='abstractentity',
            index_together=set([('type', 'name')]),
        ...
        migrations.CreateModel(
            ...
            bases=('share.workingpaperversion',),
        ),
    ]
