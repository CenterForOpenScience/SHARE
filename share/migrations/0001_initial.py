# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-08-24 01:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('award', share.models.fields.ShareURLField(blank=True)),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_contributor', to='share.Change')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_contributorversion', to='share.Change')),
                ('creative_work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.AbstractCreativeWork')),
                ('creative_work_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.AbstractCreativeWorkVersion')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_email', to='share.Change')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_emailversion', to='share.Change')),
            ],
            options={
                'abstract': False,
                'ordering': ('-date_modified',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('funder_region', share.models.fields.ShareURLField(blank=True, null=True)),
                ('community_identifier', share.models.fields.ShareURLField(blank=True, null=True)),
                ('isni', share.models.fields.ShareURLField(blank=True, null=True)),
                ('ringgold', share.models.fields.ShareURLField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('url', share.models.fields.ShareURLField()),
                ('base_url', share.models.fields.ShareURLField()),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_identifier', to='share.Change')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_identifierversion', to='share.Change')),
                ...
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.Identifier')),
                ('same_as_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.IdentifierVersion')),
                ('sources', models.ManyToManyField(editable=False, related_name='source_identifierversion', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
                'ordering': ('-date_modified',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('url', share.models.fields.URIField(db_index=True)),
                ('type', models.TextField(choices=[('doi', 'DOI'), ('provider', 'Provider'), ('misc', 'Miscellaneous'), ('eissn', 'Electronic International Standard Serial Number'), ('ark', 'ARK'), ('arxiv', 'arXiv'), ('bibcode', 'bibcode'), ('doi', 'DOI'), ('ean13', 'EAN13'), ('eissn', 'EISSN'), ('handle', 'Handle'), ('isbn', 'ISBN'), ('issn', 'ISSN'), ('istc', 'ISTC'), ('lissn', 'LISSN'), ('lsid', 'LSID'), ('pmid', 'PMID'), ('purl', 'PURL'), ('upc', 'UPC'), ('url', 'URL'), ('urn', 'URN')])),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_link', to='share.Change')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_linkversion', to='share.Change')),
                ('extra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.Link')),
                ('same_as_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.LinkVersion')),
                ('sources', models.ManyToManyField(editable=False, related_name='source_linkversion', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
                'ordering': ('-date_modified',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normalized_data', share.models.fields.DateTimeAwareJSONField(default={}, validators=[share.models.validators.JSONLDValidator()])),
            ],
        ),
        migrations.CreateModel(
            name='Person',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('family_name', models.TextField(blank=True, db_index=True)),
                ('given_name', models.TextField(blank=True, db_index=True)),
                ('additional_name', models.TextField(blank=True, db_index=True)),
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('affiliation_versions', share.models.fields.TypedManyToManyField(editable=False, through='share.Affiliation', to='share.EntityVersion')),
                ('affiliations', share.models.fields.TypedManyToManyField(through='share.Affiliation', to='share.Entity')),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_person', to='share.Change')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_personemail', to='share.Change')),
                ('email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Email')),
                ('email_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.EmailVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_personemailversion', to='share.Change')),
                ('email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Email')),
                ('email_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.EmailVersion')),
                ('extra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliation_versions', share.models.fields.TypedManyToManyField(editable=False, through='share.Affiliation', to='share.EntityVersion')),
                ('affiliations', share.models.fields.TypedManyToManyField(through='share.Affiliation', to='share.Entity')),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_personversion', to='share.Change')),
                ('email_versions', share.models.fields.TypedManyToManyField(editable=False, through='share.PersonEmail', to='share.EmailVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughawardentities', to='share.Change')),
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Entity')),
                ('entity_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.EntityVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('award', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Award')),
                ('award_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.AwardVersion')),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughawardentitiesversion', to='share.Change')),
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Entity')),
                ('entity_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.EntityVersion')),
                ('extra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughAwardEntities')),
                ('same_as_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughAwardEntitiesVersion')),
                ('sources', models.ManyToManyField(editable=False, related_name='source_throughawardentitiesversion', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ThroughAwards',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sources', models.ManyToManyField(editable=False, related_name='source_throughawardsversion', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughidentifiers', to='share.Change')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('identifier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Identifier')),
                ('identifier_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.IdentifierVersion')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Person')),
                ('person_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.PersonVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughidentifiersversion', to='share.Change')),
                ('extra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('identifier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Identifier')),
                ('identifier_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.IdentifierVersion')),
                ...
                ('person_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.PersonVersion')),
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughIdentifiers')),
                ('same_as_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughIdentifiersVersion')),
                ('sources', models.ManyToManyField(editable=False, related_name='source_throughidentifiersversion', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ThroughLinks',
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughlinks', to='share.Change')),
                ('creative_work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.AbstractCreativeWork')),
                ('creative_work_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.AbstractCreativeWorkVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.Link')),
                ('link_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.LinkVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughlinksversion', to='share.Change')),
                ('creative_work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.AbstractCreativeWork')),
                ('creative_work_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.AbstractCreativeWorkVersion')),
                ('extra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ...
                ('link_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='share.LinkVersion')),
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughLinks')),
                ('same_as_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughLinksVersion')),
                ('sources', models.ManyToManyField(editable=False, related_name='source_throughlinksversion', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
