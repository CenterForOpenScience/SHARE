# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-10-16 01:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AbstractEntityWorkRelation',
            fields=[
                ('type', models.CharField(db_index=True, max_length=255)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='AbstractEntityWorkRelationVersion',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(db_index=True, max_length=255)),
                ('action', models.TextField(max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('related', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelation')),
                ('related_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelationVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contribution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.AbstractEntityWorkRelation')),
                ('contribution_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelationVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contribution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelation')),
                ('contribution_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelationVersion')),
                ('extra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ExtraDataVersion')),
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughContributionAwards')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelation')),
                ('subject_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelationVersion')),
            ],
            options={
                'ordering': ('-date_modified',),
                'abstract': False,
        ...
        migrations.AddField(
            model_name='throughcontribution',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelation'),
        ),
        migrations.AddField(
            model_name='throughcontribution',
            name='subject_version',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelationVersion'),
        ),
        migrations.AddField(
            model_name='throughcontribution',
            name='version',
        ...
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='award_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractentityworkrelationversion_award_versions_+', through='share.ThroughContributionAwards', to='share.AwardVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='awards',
        ...
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='change',
            field=models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_abstractentityworkrelationversion', to='share.Change'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='contributed_throug_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractentityworkrelationversion_contributed_throug_versions_+', through='share.ThroughContribution', to='share.AbstractEntityWorkRelationVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='contributed_through',
            field=share.models.fields.TypedManyToManyField(through='share.ThroughContribution', to='share.AbstractEntityWorkRelation'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='creative_work',
        ...
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='same_as',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelation'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelationversion',
            name='same_as_version',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractEntityWorkRelationVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='award_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractentityworkrelation_award_versions_+', through='share.ThroughContributionAwards', to='share.AwardVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='awards',
        ...
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='change',
            field=models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_abstractentityworkrelation', to='share.Change'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='contributed_throug_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractentityworkrelation_contributed_throug_versions_+', through='share.ThroughContribution', to='share.AbstractEntityWorkRelationVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='contributed_through',
        ...
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='creative_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entity_relations', to='share.AbstractCreativeWork'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='creative_work_version',
        ...
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='entity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work_relations', to='share.AbstractEntity'),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='entity_version',
        ...
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='sources',
            field=models.ManyToManyField(editable=False, related_name='source_abstractentityworkrelation', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='abstractentityworkrelation',
            name='version',
            field=models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='share_abstractentityworkrelation_version', to='share.AbstractEntityWorkRelationVersion'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractentityversion_related_work_versions_+', through='share.AbstractEntityWorkRelation', to='share.AbstractCreativeWorkVersion'),
        ),
        migrations.AddField(
            model_name='abstractentityversion',
            name='related_works',
            field=share.models.fields.TypedManyToManyField(related_name='_abstractentityversion_related_works_+', through='share.AbstractEntityWorkRelation', to='share.AbstractCreativeWork'),
        ),
        migrations.AddField(
            model_name='abstractentityversion',
            name='same_as',
        ...
        migrations.AddField(
            model_name='abstractentity',
            name='related_work_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractentity_related_work_versions_+', through='share.AbstractEntityWorkRelation', to='share.AbstractCreativeWorkVersion'),
        ),
        migrations.AddField(
            model_name='abstractentity',
            name='related_works',
            field=share.models.fields.TypedManyToManyField(through='share.AbstractEntityWorkRelation', to='share.AbstractCreativeWork'),
        ),
        migrations.AddField(
            model_name='abstractentity',
            name='same_as',
        ...
        migrations.AddField(
            model_name='abstractcreativeworkversion',
            name='related_entitie_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractcreativeworkversion_related_entitie_versions_+', through='share.AbstractEntityWorkRelation', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
            model_name='abstractcreativeworkversion',
            name='related_entities',
            field=share.models.fields.TypedManyToManyField(related_name='_abstractcreativeworkversion_related_entities_+', through='share.AbstractEntityWorkRelation', to='share.AbstractEntity'),
        ),
        migrations.AddField(
            model_name='abstractcreativeworkversion',
            name='related_work_versions',
        ...
        migrations.AddField(
            model_name='abstractcreativework',
            name='related_entitie_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractcreativework_related_entitie_versions_+', through='share.AbstractEntityWorkRelation', to='share.AbstractEntityVersion'),
        ),
        migrations.AddField(
            model_name='abstractcreativework',
            name='related_entities',
            field=share.models.fields.TypedManyToManyField(through='share.AbstractEntityWorkRelation', to='share.AbstractEntity'),
        ),
        migrations.AddField(
            model_name='abstractcreativework',
            name='related_work_versions',
        ...
        migrations.CreateModel(
            name='EntityWorkRelation',
            fields=[
            ],
            options={
                'proxy': True,
            },
            bases=('share.abstractentityworkrelation',),
        ),
        migrations.CreateModel(
            name='EntityWorkRelationVersion',
            fields=[
            ],
            options={
                'proxy': True,
            },
            bases=('share.abstractentityworkrelationversion',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=('share.entityworkrelation',),
        ),
        migrations.CreateModel(
            ...
            bases=('share.entityworkrelationversion',),
        ),
        migrations.CreateModel(
            name='DataSet',
            fields=[
