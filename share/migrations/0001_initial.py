# -*- coding: utf-8 -*-
<<<<<<< 3f836b3faadb2a7a8671c25d9cc3a6d257b570d7
# Generated by Django 1.9.7 on 2016-10-20 20:45
=======
# Generated by Django 1.9.7 on 2016-10-20 16:51
>>>>>>> Update migrations
...
>>>>>>> Update migrations
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughcontributorawards', to='share.Change')),
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='share.AbstractAgentWorkRelation')),
                ('contributor_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractAgentWorkRelationVersion')),
                ('extra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.OneToOneField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraDataVersion')),
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughContributorAwards')),
            ],
        ),
        migrations.CreateModel(
            name='ThroughContributorAwardsVersion',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.TextField(max_length=10)),
                ('persistent_id', models.PositiveIntegerField()),
                ...
                ('award_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AwardVersion')),
                ('change', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='affected_throughcontributorawardsversion', to='share.Change')),
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractAgentWorkRelation')),
                ('contributor_version', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.AbstractAgentWorkRelationVersion')),
                ('extra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='share.ExtraData')),
                ('extra_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ExtraDataVersion')),
                ('same_as', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughContributorAwards')),
                ('same_as_version', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughContributorAwardsVersion')),
            ],
            options={
                'db_table': None,
            },
        ...
        migrations.AddField(
            model_name='throughcontributorawards',
            name='same_as_version',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='share.ThroughContributorAwardsVersion'),
        ),
        migrations.AddField(
            model_name='throughcontributorawards',
            name='sources',
            field=models.ManyToManyField(editable=False, related_name='source_throughcontributorawards', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='throughcontributorawards',
            name='version',
            field=models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='share_throughcontributorawards_version', to='share.ThroughContributorAwardsVersion'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='award_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractagentworkrelationversion_award_versions_+', through='share.ThroughContributorAwards', to='share.AwardVersion'),
        ),
        migrations.AddField(
            model_name='abstractagentworkrelationversion',
            name='awards',
            field=share.models.fields.TypedManyToManyField(through='share.ThroughContributorAwards', to='share.Award'),
        ),
        migrations.AddField(
            model_name='abstractagentworkrelationversion',
            name='change',
        ...
        migrations.AddField(
            ...
            name='award_versions',
            field=share.models.fields.TypedManyToManyField(editable=False, related_name='_abstractagentworkrelation_award_versions_+', through='share.ThroughContributorAwards', to='share.AwardVersion'),
        ),
        migrations.AddField(
            model_name='abstractagentworkrelation',
            name='awards',
        ...
        migrations.AlterUniqueTogether(
            name='throughcontributorawards',
            unique_together=set([('contributor', 'award')]),
        ),
        migrations.AddField(
            model_name='rawdata',
            name='tasks',
