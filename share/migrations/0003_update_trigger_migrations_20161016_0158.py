# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-10-16 01:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql='CREATE OR REPLACE FUNCTION before_share_entityidentifier_change() RETURNS trigger AS $$\n        DECLARE\n            vid INTEGER;\n        BEGIN\n            INSERT INTO share_entityidentifierversion(persistent_id, action, change_id, date_created, date_modified, entity_id, entity_version_id, extra_id, extra_version_id, host, same_as_id, same_as_version_id, scheme, uri) VALUES (NEW.id, TG_OP, NEW.change_id, NEW.date_created, NEW.date_modified, NEW.entity_id, NEW.entity_version_id, NEW.extra_id, NEW.extra_version_id, NEW.host, NEW.same_as_id, NEW.same_as_version_id, NEW.scheme, NEW.uri) RETURNING (id) INTO vid;\n            NEW.version_id = vid;\n            RETURN NEW;\n        END;\n        $$ LANGUAGE plpgsql;',
        ...
        migrations.RunSQL(
            sql='CREATE OR REPLACE FUNCTION before_share_abstractentityworkrelation_change() RETURNS trigger AS $$\n        DECLARE\n            vid INTEGER;\n        BEGIN\n            INSERT INTO share_abstractentityworkrelationversion(persistent_id, action, bibliographic, change_id, cited_as, creative_work_id, creative_work_version_id, date_created, date_modified, entity_id, entity_version_id, extra_id, extra_version_id, order_cited, same_as_id, same_as_version_id, type) VALUES (NEW.id, TG_OP, NEW.bibliographic, NEW.change_id, NEW.cited_as, NEW.creative_work_id, NEW.creative_work_version_id, NEW.date_created, NEW.date_modified, NEW.entity_id, NEW.entity_version_id, NEW.extra_id, NEW.extra_version_id, NEW.order_cited, NEW.same_as_id, NEW.same_as_version_id, NEW.type) RETURNING (id) INTO vid;\n            NEW.version_id = vid;\n            RETURN NEW;\n        END;\n        $$ LANGUAGE plpgsql;',
            reverse_sql='DROP FUNCTION before_share_abstractentityworkrelation_change();',
        ),
        migrations.RunSQL(
            sql='DROP TRIGGER IF EXISTS share_abstractentityworkrelation_change ON share_abstractentityworkrelation;\n\n        CREATE TRIGGER share_abstractentityworkrelation_change\n        BEFORE INSERT OR UPDATE ON share_abstractentityworkrelation\n        FOR EACH ROW\n        EXECUTE PROCEDURE before_share_abstractentityworkrelation_change();',
            reverse_sql='DROP TRIGGER share_abstractentityworkrelation_change',
        ),
        migrations.RunSQL(
