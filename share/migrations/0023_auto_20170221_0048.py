# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-02-21 00:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('share_version', models.TextField(default='2.4.0-20-gd500455')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logs', models.ManyToManyField(to='share.HarvestLog')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='sourceicon',
            name='source',
            field=models.OneToOneField(default=1, on_delete=db.deletion.DatabaseOnDelete(clause='CASCADE'), to='share.Source'),
