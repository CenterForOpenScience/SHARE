...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql='CREATE OR REPLACE FUNCTION before_share_relation_change() RETURNS trigger AS $$\n        DECLARE\n            vid INTEGER;\n        BEGIN\n            INSERT INTO share_relationversion(persistent_id, action, change_id, date_created, date_modified, extra_id, extra_version_id, object_work_id, object_work_version_id, relation_type_id, same_as_id, same_as_version_id, subject_work_id, subject_work_version_id, uuid) VALUES (NEW.id, TG_OP, NEW.change_id, NEW.date_created, NEW.date_modified, NEW.extra_id, NEW.extra_version_id, NEW.object_work_id, NEW.object_work_version_id, NEW.relation_type_id, NEW.same_as_id, NEW.same_as_version_id, NEW.subject_work_id, NEW.subject_work_version_id, NEW.uuid) RETURNING (id) INTO vid;\n            NEW.version_id = vid;\n            RETURN NEW;\n        END;\n        $$ LANGUAGE plpgsql;',
