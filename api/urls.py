...
register_route(r'sourceconfigs', views.SourceConfigViewSet)
register_route(r'harvesters', views.HarvesterViewSet)
register_route(r'transformers', views.TransformerViewSet)
